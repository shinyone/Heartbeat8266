...
const char html_page_watchdog[] PROGMEM =
"<div id='l1' name='l1'>"
    "<fieldset>"
        "<legend><b>&nbsp; _TXT_WATCHDOG_TITLE_ &nbsp;</b></legend>"
        "<form method='post'>"
            "<p><b>_TXT_WATCHDOG_SUBSCRIBE_TOPIC_</b>"
                "<br/>"
                "<input id='wst' name='wst' "
                "autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' "
                "placeholder=' ' value='_WATCHDOG_SUBSCRIBE_TOPIC_'>"
            "</p>"
            "<p><b>_TXT_WATCHDOG_PUBLISH_TOPIC_</b>"
                "<br/>"
                "<input id='wpt' name='wpt' "
                "autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' "
                "placeholder=' ' value='_WATCHDOG_PUBLISH_TOPIC_'>"
            "</p>"
            "<br/>"
            "<button name='save' type='submit' class='button bgrn'>_TXT_SAVE_</button>"
        "</form>"
...
const char html_page_debug[] PROGMEM =
"<div id='l1' name='l1'>"
    "<fieldset>"
        "<legend><b>&nbsp; _TXT_DEBUG_TITLE_ &nbsp;</b></legend>"
        "<form method='post'>"
            "<p><b>_TXT_DEBUG_ONOFF_</b>"
                "<select name='debug'>"
    ...
    "</fieldset>"
        "<fieldset>"
        "<legend><b>&nbsp; _TXT_DEBUG_LOG_ &nbsp;</b></legend>"
           "<p>"
            "_DEBUG_CONSOLE_"
          "</p>"
        "</fieldset>"
